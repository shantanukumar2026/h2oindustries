    ...
    >
      ...
      <div style={{ position: "absolute", top: "10%", right: "-10%", width: "70%", height: "80%", opacity: 0.1, pointerEvents: "none" }}>
        <svg viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Connection Lines */}
          <path d="M200,200 Q400,100 600,250" stroke="#42A5F5" strokeWidth="2" strokeDasharray="5 5" fill="none" />
          <path d="M300,300 Q500,400 700,300" stroke="#42A5F5" strokeWidth="2" strokeDasharray="5 5" fill="none" />
          <circle cx="200" cy="200" r="8" fill="#1565C0" stroke="#42A5F5" strokeWidth="3" />
          <circle cx="600" cy="250" r="8" fill="#1565C0" stroke="#42A5F5" strokeWidth="3" />
          <circle cx="300" cy="300" r="8" fill="#1565C0" stroke="#42A5F5" strokeWidth="3" />
          <circle cx="700" cy="300" r="8" fill="#1565C0" stroke="#42A5F5" strokeWidth="3" />
        </svg>
      </div>
      ...
      <div style={{ maxWidth: 1720, margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 10 }}>
        <div ref={ref} style={{ display: "flex", flexWrap: "wrap", gap: 60, alignItems: "center" }}>
            ...
            <div style={{ display: "flex", gap: 40, marginBottom: 48 }}>
              {stats.map((stat, i) => (
                <div key={i}>
                  ...
                  <div style={{ color: "#42A5F5", fontSize: 13, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5, marginTop: 8 }}>
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          >
             {/* The SVG background handles the visual aspect, this is a placeholder for structural balance */}
             <div style={{ width: "100%", height: 400, border: "1px solid rgba(33, 150, 243, 0.2)", background: "rgba(6, 35, 71, 0.4)", backdropFilter: "blur(8px)", position: "relative", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <div style={{ textAlign: "center" }}>
                  <Globe2 size={64} color="rgba(33, 150, 243, 0.3)" style={{ marginBottom: 16 }} />
                  <div style={{ color: "#42A5F5", fontSize: 14, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase" }}>Live Network Routing</div>
                </div>
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    borderRadius: "50%",
                    background: "conic-gradient(from 0deg, transparent 70%, rgba(33, 150, 243, 0.2) 100%)",
