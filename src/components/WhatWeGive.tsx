  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 10 }}>
        <div ref={ref} style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", maxWidth: 800, margin: "0 auto 64px auto" }}>
          ...
          >
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,0.1)", padding: "8px 16px", marginBottom: 24, borderRadius: 4, borderLeft: "2px solid #42A5F5" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {data.paragraphs.map((p, i) => (
                <p key={i} style={{ color: "#BBDEFB", fontSize: 18, lineHeight: 1.7, fontWeight: 400, margin: 0 }}>
                  {p}
                </p>
              ))}
            </div>
